...
## Note - this test player always moves to the direction specified in its constructor
...
class Player:
    ...
    def __init__(self, money_payout_rates, my_spawn_point, their_spawn_point, direction = None):
